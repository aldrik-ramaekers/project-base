...
gcc -m64 -c -Wall -Wno-maybe-uninitialized -DMODE_DEBUG -g src/entry.c -o build/libprojectbase-debug.o
...
gcc -m64 -g -DMODE_DEBUG examples/example_window.c -o build/example_window.exe -lprojectbase-debug
